...
Vertical A4 Canvas: Hardcoded to perfectly map to physical A4 paper, automatically scaling to any screen size.
...
Touch Friendly: The Web App is fully compatible with tablets and mobile phones, featuring a custom pointer system for tapping and dragging!


🖼️ Advanced Image Support
Drag & Drop: Pull photos directly from your folders onto the paper.
Clipboard Paste: Found a photo online? Just copy it and hit Ctrl+V (or click the PASTE button) to instantly drop it onto the canvas.
...
11+ Formats Supported: Works with .jpg, .png, .gif, .webp, .bmp, .tiff, .tif, .avif, and even iPhone .heic/.heif files.
...
💾 Flexible Outputs
🖨️ Print A4: Directly send your masterpiece to your home printer in high quality.
💾 Save JPG: Export the entire collage as a perfectly sized A4 image file.
📄 Save PDF: Generate a professional PDF document of the canvas for easy sharing or professional printing.
↩️ Total Safety
...
git clone [https://github.com/YOUR_USERNAME/kids-photo-studio.git](https://github.com/YOUR_USERNAME/kids-photo-studio.git)
...
Run the application:
python kids_studio.py


🤝 How to Contribute
This is an Open Source project! We welcome contributions from other parents and developers. If you have ideas for adding text tools, stickers, or pen drawing, please Fork the project and submit a Pull Request.
📜 License
Licensed under the MIT License. Use it, share it, and change it!
